...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <div class="card">
        <header class="card-header"><div class="card-title">新增轮播图</div></header>
        <div class="card-body">
          
          <form action="{{url('admin/save_banner')}}" method="post" class="row add" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            <div class="mb-3 col-md-12">
              <label for="title" class="form-label">*主标题</label>
              <input type="text" class="form-control" id="first_title" name="first_title" value="" placeholder="输入主标题" />
            </div>
            <div class="mb-3 col-md-12">
              <label for="sort" class="form-label">副标题</label>
              <input type="text" class="form-control" id="second_title" name="second_title" value="" placeholder="输入副标题" />
            </div>
            <div class="mb-3 col-md-12">
              <label for="sort" class="form-label">跳转地址</label>
              <input type="text" class="form-control" id="url" name="url" value="" placeholder="输入跳转地址" />
            </div>
            <div class="mb-3 col-md-12">
            ...
            <div class="mb-3 col-md-12">
              ...
              <div class="clearfix">
                <div class="form-check form-check-inline">
      	          <input type="radio" id="is_show" name="is_show" value="1" class="form-check-input" checked>
      	          <label class="form-check-label" for="shangjia">上架</label>
      	        </div>
      	        <div class="form-check form-check-inline">
      	          <input type="radio" id="is_show" name="is_show" value="0" class="form-check-input">
            ...
            <div class="mb-3 col-md-12">
              <button type="submit" class="btn btn-sm btn-primary ajax-post" target-form="add-form">添 加</button>
